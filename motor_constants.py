...
#1. ANYTHING RELATED TO THE STEPPER MOTOR
    #STEP ANGLE, MICROSTEPS PER STEP,SCREW PITCH, THE DIRECTION AND PULSE PINS ON THE PI.
#2. THE GPIO PIN FOR THE  LIMITSWITCH
#3. THE DIRECTION THAT THE MOTOR WILL MOVE. ETCHANT DIRECTION REFERS TO THE STAGE MOVING TOWARDS THE ETCHANT 
...
#4. IF THERE IS NO LIMITSWITCH PRESENT SET ENDSTOP_ENABLED TO FALSE AND IF THERE IS A LIMITSWITCH SET ENDSTOP_ENABLED TO TRUE
